...
export default function AssessmentIntelligenceTabs({
    ...
    const summaryText =
        useMemo(() => {
            ...
            return (
                aiInsight.executiveSummary.length > 220
        ...
        <section className="aii">
            ...
            <div className="aii__header">
                ...
                <div>
                    ...
                    <h2 className="aii__title">
                        AI Assessment Intelligence
                    </h2>

                    <p className="aii__subtitle">
                        Interactive AI-generated security intelligence and remediation insights
                    </p>
                ...
                <div
                    className={
                        `aii__confidence ${!aiInsight
                            ? "aii__confidence--empty"
                            : ""
                        }`
                    }
                >

                    <span className="aii__confidence-label">
                        Confidence
                    </span>
            ...
            {aiInsight ? (
                ...
                <div className="aii-summary-grid">
                    ...
                    <div className="aii-card">
                        ...
                        <div className="aii-recommendation-preview-list">
                            ...
                            {recommendationPreview.map(
                                (item, index) => (

                                    <div
                                        key={index}
                                        className="aii-recommendation-preview"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span
                                                className={
                                                    `aii-priority aii-priority--${item.priority?.toLowerCase()}`
                                                }
                                            >
                                                {item.priority}
                                            </span>
                ...
                <div className="aii-empty">
                    ...
                    <h3>
                        AI Intelligence Not Available
                    </h3>

                    <p>
                        This assessment does not contain AI-generated insights yet.
                    </p>
            ...
            <div className="aii-tabs">
                ...
                <button
                    className={
                        `aii-tab ${activeTab === "recommendations"
                            ? "aii-tab--active"
                            : ""}`
                    }
                    onClick={() =>
                ...
                {activeTab === "recommendations" && (
                    ...
                    aiRecommendations.length > 0 ? (
                            ...
                            {aiRecommendations.map(
                                (recommendation, index) => {
                                    ...
                                    return (
                                        ...
                                        <div
                                            key={index}
                                            className="aii-recommendation-accordion"
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="aii-recommendation-accordion__right">
                                                    ...
                                                    <span
                                                        className={
                                                            `aii-priority aii-priority--${recommendation.priority?.toLowerCase()}`
                                                        }
                                                    >
                                                    ...
                                                    <ChevronDown
                                                        size={18}
                                                        className={
                                                            `aii-chevron ${isExpanded
                                                                ? "aii-chevron--expanded"
                                                                : ""
                                                            }`
                                                        }
                                                    />
                        ...
                        <div className="aii-empty">
                            ...
                            <p>
                                Recommendations will appear after AI analysis is generated.
                            </p>
